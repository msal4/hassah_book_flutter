...
part 'search.query.graphql.g.dart';

@JsonSerializable(explicitToJson: true)
class Variables$Query$Search {
  Variables$Query$Search({this.searchQuery, this.order, this.skip, this.take});
...
class Query$Search {
  ...
  final Query$Search$authors authors;

  final Query$Search$products products;
  ...
  int get hashCode {
    ...
    return Object.hashAll([l$authors, l$products, l$$__typename]);
  }
  ...
  bool operator ==(Object other) {
    ...
    if (l$authors != lOther$authors) return false;
    final l$products = products;
...
extension UtilityExtension$Query$Search on Query$Search {
  Query$Search copyWith(
          {Query$Search$authors? authors,
          Query$Search$products? products,
          String? $__typename}) =>
      Query$Search(
          authors: authors == null ? this.authors : authors,
...
extension ClientExtension$Query$Search on graphql.GraphQLClient {
  ...
  Query$Search? readQuery$Search(
      {Variables$Query$Search? variables, bool optimistic = true}) {
...
@JsonSerializable(explicitToJson: true)
class Query$Search$authors implements Fragment$PaginatedAuthorResponse {
  Query$Search$authors(
      {required this.items,
  ...
  @override
  factory Query$Search$authors.fromJson(Map<String, dynamic> json) =>
      _$Query$Search$authorsFromJson(json);

  final List<Query$Search$authors$items> items;
  ...
  Map<String, dynamic> toJson() => _$Query$Search$authorsToJson(this);
  int get hashCode {
    final l$items = items;
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (!(other is Query$Search$authors) || runtimeType != other.runtimeType)
      return false;
    final l$items = items;
...
extension UtilityExtension$Query$Search$authors on Query$Search$authors {
  Query$Search$authors copyWith(
          {List<Query$Search$authors$items>? items,
          bool? hasMore,
          int? total,
          String? $__typename}) =>
      Query$Search$authors(
...
@JsonSerializable(explicitToJson: true)
class Query$Search$authors$items
    implements Fragment$PaginatedAuthorResponse$items, Fragment$Author {
  Query$Search$authors$items(
      {required this.id,
      required this.name,
      required this.image,
  ...
  @override
  factory Query$Search$authors$items.fromJson(Map<String, dynamic> json) =>
      _$Query$Search$authors$itemsFromJson(json);
  ...
  Map<String, dynamic> toJson() => _$Query$Search$authors$itemsToJson(this);
  int get hashCode {
    final l$id = id;
    final l$name = name;
    final l$image = image;
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (!(other is Query$Search$authors$items) ||
...
extension UtilityExtension$Query$Search$authors$items
    on Query$Search$authors$items {
  Query$Search$authors$items copyWith(
          {String? id,
          String? name,
          String? image,
          String? overview,
...
@JsonSerializable(explicitToJson: true)
class Query$Search$products implements Fragment$PaginatedProductResponse {
  ...
  @override
  factory Query$Search$products.fromJson(Map<String, dynamic> json) =>
      _$Query$Search$productsFromJson(json);

  final List<Query$Search$products$items> items;
  ...
  Map<String, dynamic> toJson() => _$Query$Search$productsToJson(this);
  int get hashCode {
    final l$items = items;
    final l$hasMore = hasMore;
    final l$total = total;
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (!(other is Query$Search$products) || runtimeType != other.runtimeType)
      return false;
    final l$items = items;
    final lOther$items = other.items;
    if (l$items.length != lOther$items.length) return false;
...
extension UtilityExtension$Query$Search$products on Query$Search$products {
  Query$Search$products copyWith(
          {List<Query$Search$products$items>? items,
          bool? hasMore,
          int? total,
          String? $__typename}) =>
      Query$Search$products(
...
@JsonSerializable(explicitToJson: true)
class Query$Search$products$items
  ...
  @override
  factory Query$Search$products$items.fromJson(Map<String, dynamic> json) =>
      _$Query$Search$products$itemsFromJson(json);
  ...
  final Query$Search$products$items$author author;

  final List<Query$Search$products$items$categories> categories;

  @JsonKey(name: '__typename')
  final String $__typename;

  Map<String, dynamic> toJson() => _$Query$Search$products$itemsToJson(this);
  int get hashCode {
    final l$id = id;
    final l$name = name;
    final l$price = price;
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (!(other is Query$Search$products$items) ||
        runtimeType != other.runtimeType) return false;
    final l$id = id;
    final lOther$id = other.id;
    if (l$id != lOther$id) return false;
...
extension UtilityExtension$Query$Search$products$items
    on Query$Search$products$items {
  Query$Search$products$items copyWith(
          {String? id,
          String? name,
          double? price,
          String? image,
          String? overview,
          Query$Search$products$items$author? author,
          List<Query$Search$products$items$categories>? categories,
          String? $__typename}) =>
      Query$Search$products$items(
          id: id == null ? this.id : id,
          name: name == null ? this.name : name,
...
@JsonSerializable(explicitToJson: true)
class Query$Search$products$items$author
    implements
        Fragment$PaginatedProductResponse$items$author,
        Fragment$Product$author,
        Fragment$Author {
  Query$Search$products$items$author(
      {required this.id,
      required this.name,
      required this.image,
      required this.overview,
  ...
  @override
  factory Query$Search$products$items$author.fromJson(
          Map<String, dynamic> json) =>
      _$Query$Search$products$items$authorFromJson(json);
  ...
  Map<String, dynamic> toJson() =>
      _$Query$Search$products$items$authorToJson(this);
  int get hashCode {
    final l$id = id;
    final l$name = name;
    final l$image = image;
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (!(other is Query$Search$products$items$author) ||
        runtimeType != other.runtimeType) return false;
    final l$id = id;
    final lOther$id = other.id;
    if (l$id != lOther$id) return false;
...
extension UtilityExtension$Query$Search$products$items$author
    on Query$Search$products$items$author {
  Query$Search$products$items$author copyWith(
          {String? id,
          String? name,
          String? image,
          String? overview,
...
@JsonSerializable(explicitToJson: true)
class Query$Search$products$items$categories
    implements
        Fragment$PaginatedProductResponse$items$categories,
        Fragment$Product$categories,
        Fragment$Category {
  Query$Search$products$items$categories(
      {required this.id, required this.name, required this.$__typename});

  @override
  factory Query$Search$products$items$categories.fromJson(
          Map<String, dynamic> json) =>
      _$Query$Search$products$items$categoriesFromJson(json);
  ...
  Map<String, dynamic> toJson() =>
      _$Query$Search$products$items$categoriesToJson(this);
  int get hashCode {
    final l$id = id;
    final l$name = name;
    final l$$__typename = $__typename;
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (!(other is Query$Search$products$items$categories) ||
        runtimeType != other.runtimeType) return false;
    final l$id = id;
    final lOther$id = other.id;
    if (l$id != lOther$id) return false;
...
extension UtilityExtension$Query$Search$products$items$categories
    on Query$Search$products$items$categories {
  Query$Search$products$items$categories copyWith(
