...
class ProductDetailsCard extends HookWidget {
  const ProductDetailsCard({Key key, @required this.product, this.isBookmarked = false, this.onBookmarkTap})
      : assert(product != null),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(product.name, style: theme.textTheme.headline6, overflow: TextOverflow.ellipsis),
                      Text("by ${product.author.name}", style: theme.textTheme.bodyText2, overflow: TextOverflow.ellipsis),
